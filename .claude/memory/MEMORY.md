...
- [Triage-ded ledger status](project_triage_ded_ledger_status.md) — **FINAL pilot state 2026-08-21: 98.6%, 19,083/19,354 matched, Language only 136, No 135.** Residual is adjudicated `genuine_divergence`, AI-triaged and unreviewed — never fold it into a published rate.
...
denominator caveat (653 subgroup-DB orphans excluded; 95.4% against the full 20,007-row scrape),
